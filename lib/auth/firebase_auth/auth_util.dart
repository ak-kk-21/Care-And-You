...
DocumentReference? get currentUserReference =>
    loggedIn ? PatientsRecord.collection.doc(currentUser!.uid) : null;

PatientsRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : PatientsRecord.getDocument(PatientsRecord.collection.doc(uid))
              .handleError((_) {}),
    )
