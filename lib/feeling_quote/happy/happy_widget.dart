...
class HappyWidget extends StatefulWidget {
  ...
  @override
  State<HappyWidget> createState() => _HappyWidgetState();
}
                      ...
                      children: [
                        ...
                        Padding(
                          padding: const EdgeInsetsDirectional.fromSTEB(
                              20.0, 0.0, 20.0, 0.0),
                          child: Text(
                            'Happiness looks gorgeous on you, wear it more often. It\'s a real kind of beauty that lights up the room and spreads joy to those nearby.',
                            textAlign: TextAlign.center,
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
