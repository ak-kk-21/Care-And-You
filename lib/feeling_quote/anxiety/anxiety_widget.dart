          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  padding:
                      const EdgeInsetsDirectional.fromSTEB(20.0, 70.0, 20.0, 50.0),
                  child: Container(
                    width: 486.0,
                    height: 634.0,
                    decoration: const BoxDecoration(
                      color: Color(0x45F1300B),
                    ),
                    child: Column(
                      mainAxisSize: MainAxisSize.max,
                      children: [
                        ...
                        Padding(
                          padding: const EdgeInsetsDirectional.fromSTEB(
                              20.0, 0.0, 20.0, 0.0),
                          child: Text(
                            'I promise you nothing is as chaotic as it seems, nothing is worth poisoning yourself into fear and anxiety so go easy on yourself, whatever you do today let it be enough.',
                            textAlign: TextAlign.center,
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
